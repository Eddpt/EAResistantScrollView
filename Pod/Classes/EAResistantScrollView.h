 ...
 *  If this is set to NO, both @c resistanceFactor and @c resistanceProgressionRation
 ...
 *  in order to achieve progressive resistance during a overscroll operation.
 */
@property (nonatomic, assign) IBInspectable float resistanceFactor;

/**
 *  This property affect how much more resistant the scroll view becomes as the user
...
/**
 *  If defined, this block is ran every time the scroll view's delegate method
